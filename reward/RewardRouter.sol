...
contract RewardRouter is IRewardRouter, ReentrancyGuard, Governable {
    ...
    address public override stakedMlpTracker;
    address public override feeMlpTracker;
    ...
    function _stakeMine(address _fundingAccount, address _account, address _token, uint256 _amount) private {
        require(_amount > 0, "RewardRouter: invalid _amount");
    ...
    function _unstakeMine(address _account, address _token, uint256 _amount, bool _shouldReduceBnMine) private {
        require(_amount > 0, "RewardRouter: invalid _amount");
